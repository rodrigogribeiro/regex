...
\end{Lemma}
\begin{proof}
  Structural induction on the derivation of \ensuremath{\V{xs}\;\D{\in\llbracket}\;\V{e}\;\D{\rrbracket}}.
\end{proof}
...
\end{Theorem}
\begin{proof}
   Structural induction over \ensuremath{\V{t}}. 
\end{proof}
...
Type \ensuremath{\D{BitRegex}} defines the syntax of BRE, which has an obvious interpretation.
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{10}{@{}>{\hspre}l<{\hspost}@{}}%
...
\\
\>[5]{}\hsindent{2}{}\<[7]%
\>[7]{}\mathrel{=}\;\C{choice}\;\C{\lbrack\:\rbrack}\;(\F{fuse}\;[\mskip1.5mu \;\C{0_b}\;\mskip1.5mu]\;(\F{internalize}\;\V{e}))\;(\F{fuse}\;[\mskip1.5mu \;\C{1_b}\;\mskip1.5mu]\;(\F{internalize}\;\V{e'})){}\<[E]%
\\
