...
The type Set1 is the type of Set and ``others like it'', such as \ensuremath{\D{Set}\;\to \;\D{Bool}},
\ensuremath{\D{String}\;\to \;\D{Set}}, and \ensuremath{\D{Set}\;\to \;\D{Set}}. There is in fact an infinite hierarchy of types of the
form \ensuremath{\D{Set}\;\V{l}}, where \ensuremath{\V{l}} is a universe level, roughly,a natural integer. This stratification
...
head function: \ensuremath{\V{head}} can be defined to accept only non-empty
...
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\C{Even}\;\mathbin{:}\;\D{Parity}\;(\V{n}\;\F{+}\;\V{n}){}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\C{Odd}\;{}\<[9]%
\>[9]{}\mathbin{:}\;\D{Parity}\;(\V{S}\;(\V{n}\;\F{+}\;\V{n})){}\<[E]%
\\[\blanklineskip]%
...
\column{11}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[3]{}\mathkw{data}\;\D{\_\in\{\_\}}\;\mathbin{:}\;\D{List}\;\D{Char}\;\to \;\D{Regexes}\;\to \;\D{Set}\;\mathkw{where}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\C{here}\;{}\<[11]%
\>[11]{}\mathbin{:}\;\V{s}\;\D{\in\llbracket}\;\V{e}\;\D{\rrbracket}\;\to \;\V{s}\;\D{\in\{}\;\V{e}\;\V{::}\;\V{es}\;\D{\}}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\C{there}\;\mathbin{:}\;\V{s}\;\D{\in\{}\;\V{es}\;\D{\}}\;\to \;\V{s}\;\D{\in\{}\;\V{e}\;\V{::}\;\V{es}\;\D{\}}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
Essentially, a value of type \ensuremath{\V{s}\;\D{\in\{}\;\V{S}\;\D{\}}} represents that \ensuremath{\V{s}} is accepted by some RE
in \ensuremath{\V{S}}. The next lemmas present the relation of \ensuremath{\V{s}\;\D{\in\{}\;\V{S}\;\D{\}}} and list concatenation.

\begin{Lemma}[Weakening left]\label{wl}
  For all sets of RE's \ensuremath{\V{S}}, \ensuremath{\V{S'}} and string \ensuremath{\V{s}}, if \ensuremath{\V{s}\;\D{\in\{}\;\V{S}\;\D{\}}} then \ensuremath{\V{s}\;\D{\in\{}\;\V{S}\;\F{++}\;\V{S'}\;\D{\}}}.
\end{Lemma}
\begin{proof}
  Straightforward induction on the derivation of \ensuremath{\V{s}\;\D{\in\{}\;\V{S}\;\D{\}}}.
\end{proof}
...
For all sets of RE's \ensuremath{\V{S}}, \ensuremath{\V{S'}} and string \ensuremath{\V{s}}, if \ensuremath{\V{s}\;\D{\in\{}\;\V{S}\;\F{++}\;\V{S'}\;\D{\}}} then \ensuremath{\V{s}\;\D{\in\{}\;\V{S}\;\D{\}}} or
\ensuremath{\V{s}\;\D{\in\{}\;\V{S'}\;\D{\}}}.
\end{Lemma}
\begin{proof}
  Induction on the derivation of \ensuremath{\V{s}\;\D{\in\{}\;\V{S}\;\F{++}\;\V{S'}\;\D{\}}} and case analysis on the
...
\ensuremath{\D{\_\in\{\_\}}}  and are omitted for brevity.
