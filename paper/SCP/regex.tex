...
In \ensuremath{\D{Vec}}'s definition, constructor \ensuremath{\C{\lbrack\:\rbrack}} builds empty vectors. The cons-operator (\ensuremath{\V{\char95 ::\char95 }})
...
\ColumnHook
\end{hscode}\resethooks
Constructors \ensuremath{\C{\emptyset}} and \ensuremath{\C{\lambda}} denote respectively the
...
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\C{\lambda}\;\mathbin{:}\;\C{\lbrack\:\rbrack}\;\D{\in\llbracket}\;\C{\lambda}\;\D{\rrbracket}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\C{\$\_}\;{}\<[9]%
...
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\C{\_\star}\;\mathbin{:}\;\V{xs}\;\D{\in\llbracket}\;\C{\lambda}\;\C{+}\;(\V{e}\;\C{∙}\;\V{e}\;\C{\star})\;\D{\rrbracket}\;\to \;\V{xs}\;\D{\in\llbracket}\;\V{e}\;\C{\star}\;\D{\rrbracket}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks

Constructor \ensuremath{\C{\lambda}} states that the empty string (denoted by the empty list \ensuremath{\C{\lbrack\:\rbrack}})
is in the language of RE \ensuremath{\C{\lambda}}.
...
Intuitively, function \ensuremath{\F{+invert}} specifies that, in the case that \ensuremath{\V{xs}\;\D{\in\llbracket}\;\V{l}\;\C{+}\;\V{r}\;\D{\rrbracket}},
the string \ensuremath{\V{xs}} matches RE \ensuremath{\V{l}} or it matches the RE \ensuremath{\V{r}}. Another inversion lemma 
(function \ensuremath{\F{charInvert}}) specifies that 
if a string \ensuremath{\V{x}\;\C{::}\;\V{xs}} matches RE \ensuremath{\C{\$}\;\V{y}} then the input string must be a single character string, 
...
\\
\>[3]{}\F{\nu[ }\;\C{\lambda}\;\F{]}\;\mathrel{=}\;\C{yes}\;\C{\lambda}{}\<[E]%
\\
...
\\
\>[3]{}\F{\nu[ }\;\V{e}\;\C{\star}\;\F{]}\;\mathrel{=}\;\C{yes}\;((\V{e}\;\C{∙}\;\V{e}\;\C{\star}\;\C{+L}\;\C{\lambda})\;\C{\star}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
of them is empty (\ensuremath{\C{\emptyset}}) the result is also empty, and the empty string is the 
...
\\
\>[3]{}\C{\lambda}\;\F{`∙}\;\V{e'}\;\mathrel{=}\;\V{e'}{}\<[E]%
\\
\>[3]{}\V{e}\;\F{`∙}\;\C{\emptyset}\;\mathrel{=}\;\C{\emptyset}{}\<[E]%
\\
\>[3]{}\V{e}\;\F{`∙}\;\C{\lambda}\;\mathrel{=}\;\V{e}{}\<[E]%
\\
\>[3]{}\V{e}\;\F{`∙}\;\V{e'}\;\mathrel{=}\;\V{e}\;\C{∙}\;\V{e'}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
For Kleene star both \ensuremath{\C{\emptyset}} and \ensuremath{\C{\lambda}} are replaced by \ensuremath{\C{\lambda}}.
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
...
\\
\>[3]{}\C{\emptyset}\;\F{`⋆}\;\mathrel{=}\;\C{\lambda}{}\<[E]%
\\
\>[3]{}\C{\lambda}\;\F{`⋆}\;\mathrel{=}\;\C{\lambda}{}\<[E]%
\\
...
\\
\>[3]{}\F{∂[}\;\C{\lambda}\;\red{,}\,\;\V{c}\;\F{]}\;\mathrel{=}\;\C{\emptyset}{}\<[E]%
\\
\>[3]{}\F{∂[}\;\C{\$}\;\V{c}\;\red{,}\,\;\V{c'}\;\F{]}\;\mathkw{with}\;\V{c}\;\F{\overset{?}{=}}\;\V{c'}{}\<[E]%
\\
\>[3]{}\V{...|}\;\C{yes}\;\C{refl}\;\mathrel{=}\;\C{\lambda}{}\<[E]%
\\
...
\\
\>[3]{}\F{\nabla[}\;\C{\lambda}\;\red{,}\,\;\V{c}\;\F{]}\;\mathrel{=}\;\C{\lbrack\:\rbrack}{}\<[E]%
\\
\>[3]{}\F{\nabla[}\;\C{\$}\;\V{x}\;\red{,}\,\;\V{c}\;\F{]}\;\mathkw{with}\;\V{x}\;\F{\overset{?}{=}}\;\V{c}{}\<[E]%
\\
\>[3]{}\F{\nabla[}\;\C{\$}\;\V{x}\;\red{,}\,\;\V{.x}\;\F{]}\;\mid \;\C{yes}\;\C{refl}\;\mathrel{=}\;[\mskip1.5mu \;\C{\lambda}\;\mskip1.5mu]{}\<[E]%
\\
