...
used in our formalization use this type. \ensuremath{\C{no}\;\V{P}} is an
...
symbols. In our Agda formalization, we represent alphabet symbols using type \ensuremath{\D{Char}}.
...
\ColumnHook
\end{hscode}\resethooks
The definition of \ensuremath{\F{\nu[\_]}} uses several inversion lemmas about
...
\ensuremath{\V{xs}\;\D{\in\llbracket}\;\F{∂[}\;\V{e}\;\red{,}\,\;\V{x}\;\F{]}\;\D{\rrbracket}} holds then \ensuremath{(\V{x}\;\V{::}\;\V{xs})\;\D{\in\llbracket}\;\V{e}\;\D{\rrbracket}} holds.
\end{Theorem}
\begin{proof}
...
\begin{Lemma}[Lemma \ensuremath{\F{¬IsPrefix-::}}]\label{pref2}
  ...
  neither does \ensuremath{\D{IsPrefix}\;(\V{x}\;\V{::}\;\V{xs})\;\V{e}}.
\end{Lemma}
\begin{proof}
